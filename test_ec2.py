...
# this 'Mock Response' class will form the payload for testing
class MockResponse:
    """
...
# Forming a class for the file, as a way to start the 'Unit Test'
class TestEc2:
...
# With the Mock Response laid out, now we trigger the function
    ec2_client = boto3.client('ec2')
    assert Get_Image(ec2_client) # assert will sucessfully complete and return something
